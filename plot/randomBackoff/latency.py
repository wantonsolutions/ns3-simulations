...
plt.axhline(y=d99p,linestyle='--', linewidth=4,  color=c, label="d-red client 99 percentile")
...
plt.axhline(y=e99p,linestyle='--', linewidth=4,  color=c, label="echo client 99 percentile")
