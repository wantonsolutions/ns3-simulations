...
#ifndef D_REDUNDANCY_CLIENT_H
#define D_REDUNDANCY_CLIENT_H
...
/**
 * \ingroup dredundancy
 * \brief A D Redundancy client
 *
 * Every packet sent should be returned by the server and received here.
 */
class DRedundancyClient : public Application 
{
public:
  /**
  ...
  /**
   * set the list of remote addresses the server will be listening on
   */
  void SetAddresses (Address* addresses, uint8_t len);
...
private:
  ...
  //New DRedundancy
  Address* m_peerAddresses; //TODO get this working on an array of addresses -> delete old
