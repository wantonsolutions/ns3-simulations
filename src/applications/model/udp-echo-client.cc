...
void UdpEchoClient::SetParallel(bool parallel) {
  m_parallel = parallel;
}


void UdpEchoClient::SetAllAddressesParallel(Address **addresses, uint16_t **ports, int **trafficMatrix, uint8_t parallel, uint32_t numPeers)
{
...
void UdpEchoClient::SetAllAddresses(Address *addresses, uint16_t *ports, int **trafficMatrix, uint32_t numPeers)
{
